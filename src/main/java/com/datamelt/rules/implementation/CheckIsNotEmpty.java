 ...
 * @author uwe geercken
 */
@CheckAnnotation(name="Check Is Not Empty", description="Checks if a string value is not empty, meaning its length is greater than zero",nameDescriptive="is not empty",checkSingleField=1)
