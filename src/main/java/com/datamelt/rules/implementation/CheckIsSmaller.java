 ...
 * @author uwe geercken
 */
@CheckAnnotation(name="Check Is Smaller", description="Check if a numeric value is smaller than the other one. In case of a String checks if the length of a String is smaller than the other one",nameDescriptive="is smaller than",checkSingleField=0)
