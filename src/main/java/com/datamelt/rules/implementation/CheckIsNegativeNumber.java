 ...
 * @author uwe geercken
 */
@CheckAnnotation(name="Check Is Negative Number", description="Checks if a number is smaller than zero",nameDescriptive="is negativ number",checkSingleField=1)
