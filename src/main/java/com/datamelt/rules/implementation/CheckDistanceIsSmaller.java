 ...
 * @author uwe geercken
 */
@CheckAnnotation(name="Check Distance Is Smaller", description="Checks if the Levenshtein distance between two strings is smaller than a given value",nameDescriptive="is smaller (Levenshtein distance)",checkSingleField=1)
